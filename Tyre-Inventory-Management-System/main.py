'''
    Tyre Management System For Aarya Sales
    Developed By->Aarya Joshi
'''
...
# OVERRIDING CLOSE BUTTON && DESTRUCTOR FOR CLASS LOGIN AND MAIN WINDOW (QUITTING CONFIRMATION)
    ...
    def buildmain(self):
        ...
        self.store_name = 'Aarya Sales Stock Management'
        self.storelable=Label(self.topframe,text=self.store_name,bg="#4267b2",anchor="center")
